...
class Program {
  ...
  public static LinkedList rearrangeLinkedList(LinkedList head, int k) {
    // Write your code here.
		...
		LinkedList[] firstPair = connectList(
			smallerListHead, smallerListTail, equalListHead, equalListTail
		);
		LinkedList[] finalPair = connectList(
			firstPair[0], firstPair[1], largerListHead, largerListTail
		);
		
    return finalPair[0];
  }
	
	private static LinkedList[] growList(
