...
class Program {
  ...
  public boolean compareLeafTraversal(BinaryTree tree1, BinaryTree tree2) {
	...
	private BinaryTree[] createLinkedList(
		BinaryTree current, BinaryTree head, BinaryTree prev
	) {
		...
		BinaryTree[] leftNodeHeadAndPrev = createLinkedList(
			current.left, head, prev
		);
		
		return createLinkedList(
			current.right, leftNodeHeadAndPrev[0], leftNodeHeadAndPrev[1]
		);
	}
