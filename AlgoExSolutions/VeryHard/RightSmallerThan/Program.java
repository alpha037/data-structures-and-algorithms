...
class Program {
  ...
  public static List<Integer> rightSmallerThan(List<Integer> array) {
    ...
    for (int i = len - 2; i >= 0; i--)
			root.insert(i, array.get(i), rightSmallerCounts, 0);
	...
	static class CustomBST {
		...
		public void insert(
			int index, int value, List<Integer> rightSmallerCounts,
			...
			if (value < this.value) {
				...
				else this.left.insert(
					index, value, rightSmallerCounts, numberOfSmallerNodes
				);
			}
			else {
