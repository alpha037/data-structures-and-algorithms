package DynamicProgramming.MinimumNumberOfInsertionsToMakeAStringPalindrome;
...
public class Solution {
  public int minimumNumberOfInsertions(String str) {
     ...
     */
    return str.length() - longestCommonSubsequenceDPSpaceOpt(str, reversed);
  }
  ...
  public static void main(String[] args) {
    ...
    // should be 1
    System.out.println(solution.minimumNumberOfInsertions("ab"));

    // should be 0
    System.out.println(solution.minimumNumberOfInsertions("aa"));

    // should be 3
    System.out.println(solution.minimumNumberOfInsertions("abcd"));

    // should be 2
    System.out.println(solution.minimumNumberOfInsertions("abcda"));

    // should be 4
    System.out.println(solution.minimumNumberOfInsertions("abcde"));
  }
}
